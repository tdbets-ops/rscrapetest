...
- **10:30 — FLX** bought at $0.6459 (bracket -20.41%). The simulated algo's target would have closed it at $0.848 (+31.7%). **Correction:** in reality it did NOT hit its target — its sell filled at $0.6182, a real loss of -4.29%. The fill price is well below every logged resting target (0.679/0.683) and landed at 15:43:26Z, ~61 minutes after the 14:42:28Z buy fill — consistent with the step 16a2 auto-liquidate (never-touched-breakeven-60min, limit-at-bid) rule firing via the local every-10-minute Phase C loop, not a target hit. Both of today's two real buys were therefore losses via the 60-minute never-touched-breakeven auto-liquidate, despite the same in-bracket population simulating at 72-81% win rates in D3/D5 above.
